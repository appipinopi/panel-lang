...
1. ダウンロードして文脈を確認してください。
2. 修正したい箇所があれば PR を送ってください。  
3. 用語の統一が必要なら `GLOSSARY.md` を提案してください。

---

プレースホルダや HTML タグはそのまま残してください。変更後は `php -l` で構文を確認してください。校正代行も可能です。どの言語を優先しますか？
